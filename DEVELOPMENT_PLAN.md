...
|----|--------|----------|-----------|--------|
| 2.1 | Уведомления | WebSocket/polling для уведомлений о изменениях | Высокий | ✅ Completed |
| 2.2 | История изменений карточек | Версионирование содержимого карточек | Высокий | ✅ Completed |
| 2.3 | Шаблоны досок | Сохранение/применение шаблонов | Средний | ✅ Completed |
| 2.4 | Массовые операции | Выделение нескольких карточек, перемещение | Средний | ✅ Completed |
